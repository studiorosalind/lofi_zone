...
import { QuestFormPopup } from "./quest-form-popup";
...
export function QuestsManagePopup({ open, onClose }: QuestsManagePopupProps) {
  const { 
    getChapterQuests, 
    getPlotQuests, 
    getQuestsByParent, 
  ...
  const handleOpenMenu = (questId: string, event: React.MouseEvent) => {
    ...
    setQuestToEdit(quests.find(q => q.id === questId));
  };
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent className="bg-gray-800 border-gray-700 text-white">
                            <DropdownMenuItem 
                              ...
                              onClick={() => setQuestToEdit(chapter)}
                            >
                              Modify Quest
                            </DropdownMenuItem>
                          </DropdownMenuContent>
